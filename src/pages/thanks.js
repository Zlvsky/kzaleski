    ...
    <CollabWrap>
      <CollabContainer>
        ...
        <CollabRight>
          ...
          <CollabText>Dziękuje za przesłanie wiadomości! <br /> <br />
          Skontaktuje się z Tobą jak najszybciej będzie to możliwe</CollabText>
        <Link to={'/'}><CollabButton>Powrót</CollabButton></Link>
      </CollabRight>
      </CollabContainer>
    </CollabWrap>
  </MainTemplate>
